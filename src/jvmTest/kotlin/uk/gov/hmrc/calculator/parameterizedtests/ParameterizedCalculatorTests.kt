...
internal class ParameterizedCalculatorTests {
    ...
    @ParameterizedTest(name = "tax_code={0}, wages={1}, pay_period={2}, tax_year={3}, is_pension_age={4}")
    @CsvFileSource(resources = ["/data2025.csv"], numLinesToSkip = 1)
    fun `Tax calculations 2025`(
        inputTaxCode: String,
        inputWages: Double,
        @ConvertWith(PayPeriodConverter::class) inputPayPeriod: PayPeriod,
        @ConvertWith(TaxYearConverter::class) inputTaxYear: TaxYear,
    ...
    @ParameterizedTest(name = "tax_code={0}, wages={1}, pay_period={2}, tax_year={3}, is_pension_age={4}")
    @CsvFileSource(resources = ["/data2025_with_pension.csv"], numLinesToSkip = 1)
    fun `Tax calculations 2025 with 10 percent Pension contribution`(
        inputTaxCode: String,
        inputWages: Double,
        @ConvertWith(PayPeriodConverter::class) inputPayPeriod: PayPeriod,
        @ConvertWith(TaxYearConverter::class) inputTaxYear: TaxYear,
    ...
    @ParameterizedTest(name = "tax_code={0}, wages={1}, pay_period={2}, tax_year={3}, is_pension_age={4}")
    @CsvFileSource(resources = ["/data2025_with_student_loan.csv"], numLinesToSkip = 1)
    fun `Tax calculations 2025 with student loan`(
        inputTaxCode: String,
        inputWages: Double,
        @ConvertWith(PayPeriodConverter::class) inputPayPeriod: PayPeriod,
        @ConvertWith(TaxYearConverter::class) inputTaxYear: TaxYear,
    ...
    @ParameterizedTest(name = "tax_code={0}, wages={1}, pay_period={2}, tax_year={3}, is_pension_age={4}")
    @CsvFileSource(resources = ["/data2025_with_tapering.csv"], numLinesToSkip = 1)
    fun `Tax calculations 2025 with tapering`(
        inputTaxCode: String,
        inputWages: Double,
        @ConvertWith(PayPeriodConverter::class) inputPayPeriod: PayPeriod,
        @ConvertWith(TaxYearConverter::class) inputTaxYear: TaxYear,
