...
class TCodesTests {
    ...
    fun `100T England 40k`() {
        val calculator = Calculator("100T", 40000.0, payPeriod = YEARLY, taxYear = 2019).run()
    ...
    fun `100T England 138499`() {
        val calculator = Calculator("100T", 138499.0, payPeriod = YEARLY, taxYear = 2019).run()
    ...
    fun `100T England 138501`() {
        val calculator = Calculator("100T", 138501.0, payPeriod = YEARLY, taxYear = 2019).run()
    ...
    fun `C100T England 138499`() {
        val calculator = Calculator("C100T", 138499.0, payPeriod = YEARLY, taxYear = 2019).run()
        assertEquals(6734.139999999999, calculator.yearly.employeesNI)
        assertEquals(17921.646, calculator.yearly.employersNI)
        assertEquals(47497.80, calculator.yearly.taxToPay)
    }
    ...
    fun `C100T England 138501`() {
        val calculator = Calculator("C100T", 138501.0, payPeriod = YEARLY, taxYear = 2019).run()
        assertEquals(6734.18, calculator.yearly.employeesNI)
        assertEquals(17921.922000000002, calculator.yearly.employersNI)
        assertEquals(47498.649999999994, calculator.yearly.taxToPay)
    }
    ...
    fun `S100T Scotland 138501`() {
        val calculator = Calculator("S100T", 138501.00, payPeriod = YEARLY, taxYear = 2019).run()
        assertEquals(6734.18, calculator.yearly.employeesNI)
        assertEquals(17921.922000000002, calculator.yearly.employersNI)
    ...
    fun `S100T Scotland 138499`() {
        val calculator = Calculator("S100T", 138499.00, payPeriod = YEARLY, taxYear = 2019).run()
        assertEquals(6734.139999999999, calculator.yearly.employeesNI)
        assertEquals(17921.646, calculator.yearly.employersNI)
