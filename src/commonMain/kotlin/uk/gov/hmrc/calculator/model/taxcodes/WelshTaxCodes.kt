...
internal class CTCode(private val taxFreeAmountWithoutTrailingZero: Double) :
    WelshTaxCode,
    AdjustedTaxFreeTCode {
    override val taxFreeAmount: Double
...
internal class WelshEmergencyCode(private val taxFreeAmountWithoutTrailingZero: Double) :
    WelshTaxCode,
    EmergencyTaxCode {
    override val taxFreeAmount: Double
        get() = taxFreeAmountWithoutTrailingZero * 10 + 9
...
internal class WelshMCode(private val taxFreeAmountWithoutTrailingZero: Double) :
    WelshTaxCode,
    MarriageTaxCodes {
...
internal class WelshNCode(private val taxFreeAmountWithoutTrailingZero: Double) :
    WelshTaxCode,
    MarriageTaxCodes {
    override val increasedTaxAllowance: Boolean
        get() = false
...
internal class CKCode(private val amountToAddToWagesFromCode: Double) :
    WelshTaxCode,
    KTaxCode {
